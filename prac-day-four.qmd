...
```{r}
# Calculate the average arrival delay for each airline on multi-airline routes  
flights |>   
  filter(paste(origin, dest) %in% paste(mult_flights$origin, mult_flights$dest)) |>   
...
Detected missing values: height and glucose 
